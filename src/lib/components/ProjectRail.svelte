...
<div class="w-52 shrink-0 h-full bg-card border-r border-line flex flex-col">
  ...
  <!-- footer: settings gear + signed-in user / logout -->
  <div class="border-t border-line px-3 py-2 flex items-center gap-2 text-xs text-muted">
    ...
    {/if}
    <button class="hover:text-content shrink-0 leading-none flex items-center justify-center min-w-[44px] min-h-[44px] -my-2 rounded hover:bg-line/50" title="Settings" aria-label="Settings" onclick={onSettings}>
